 ...
 */
export const HAPToMatterDeviceMapping = {
    // Lighting services
 ...
 */
export function getMatterDeviceTypeForHAPService(serviceType, characteristics) {
 ...
 */
export function getMatterClustersForHAPService(serviceType, characteristics) {
