...
export class Server {
    ...
    constructor(options = {}) {
        ...
        this.matterService = new MatterService(this.config.matter || {}, this.pluginManager, this.externalPortService, this.api, this.options);
        // Set up Matter event handlers
        this.api.on("publishMatterAccessories" /* InternalAPIEvent.PUBLISH_MATTER_ACCESSORIES */, this.handlePublishMatterAccessories.bind(this));
        this.api.on("unpublishMatterAccessories" /* InternalAPIEvent.UNPUBLISH_MATTER_ACCESSORIES */, this.handleUnpublishMatterAccessories.bind(this));
    ...
    handlePublishMatterAccessories(accessories) {
    ...
    handleUnpublishMatterAccessories(accessories) {
